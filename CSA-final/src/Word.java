...
public class Word {
    ...
    // sets up the allWords list from the String
    static {
        init();
    }
    ...
    /**
     * Sets the allWords to a list of words from the String
     */
    public static void init() {
        ArrayList<Word> wordsList = new ArrayList<>();
        String[] wordsFromString = words.split("\n");
        for(String w : wordsFromString) {
            wordsList.add(new Word(w.trim()));
        }
